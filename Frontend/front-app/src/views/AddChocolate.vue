<template>
    <div class="container">
        <button @click="this.$router.push({ name: 'FactoryList'})" class="btn-back">Back to Factories</button>
...
export default {
    ...
    methods: {
        onFileChange(event) {
            ...
            if (file) {
                this.newChocolate.image = file.name; // Store the file name
